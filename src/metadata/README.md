 ...
 * [VFB_scRNAseq.yml](VFB_scRNAseq.yml)
     * Determines how your purl.obolibrary.org/obo/VFB_scRNAseq/ redirects will be handled
     ...
     * Paste in the contents of [VFB_scRNAseq.yml](VFB_scRNAseq.yml)
 ...
 * [VFB_scRNAseq.md](VFB_scRNAseq.md)
     ...
     * Paste in the contents of [VFB_scRNAseq.md](VFB_scRNAseq.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
